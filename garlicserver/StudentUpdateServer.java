 ...
 * @author lucy
 */
public class StudentUpdateServer {
    public static final int SERVER_PORT = 8771;
    ...
    public static void main(String[] args) 
    {
        ...
        {  
            ...
            Socket sock = null;
            StudentUpdateThread updateUserThread = null;
   
            while (true)
            {
                sock = serverSock.accept();
                System.out.println("Accepted connection");
                updateUserThread = new StudentUpdateThread(sock);
